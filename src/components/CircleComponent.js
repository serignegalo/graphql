  ...
  useEffect(() => {
    ...
    svg
      ...
      .on("mouseover", function (event, d) {
        ...
        d3.select(this).attr("fill", "#FFD700"); // Change la couleur de la tranche survolée
      ...
      .on("mouseout", function () {
        d3.select(this).attr("fill", (d) => color(d.data)); // Rétablit la couleur d'origine de la tranche
  ...
  return (
    <div className="">
      ...
      <div className="flex justify-between mb-4">
        <span className="bg-green-500 w-32 rounded ml-4 text-center">
          up ratio
        </span>
        <span className="bg-indigo-500 w-32 rounded mr-4 text-center">
          down ratio
        </span>
      </div>
    </div>
